...
public class Day5Q6 {
	public static void main(String[] args) {
		...
		WebElement second = driver.findElement(By.xpath("//div[@title='Software Testing']"));
		a.moveToElement(second).perform();
		WebElement third = driver.findElement(By.xpath("//span[text()='Selenium Certification Training']"));
