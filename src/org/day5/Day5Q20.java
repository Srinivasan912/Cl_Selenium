...
public class Day5Q20 {
	public static void main(String[] args) throws AWTException {
		...
		WebElement first = driver.findElement(By.xpath("//div[text()='Appliances']"));
		a.moveToElement(first).perform();
		WebElement second = driver.findElement(By.xpath("//a[text()='Home Appliances']"));
		a.moveToElement(second).perform();
		WebElement third = driver.findElement(By.xpath("//a[text()='New Launches']"));
